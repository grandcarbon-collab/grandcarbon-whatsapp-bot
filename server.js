...
const VERIFY_TOKEN = process.env.VERIFY_TOKEN || 'grandcarbon_verify_123';
const WHATSAPP_TOKEN = process.env.WHATSAPP_TOKEN || '';
const PHONE_NUMBER_ID = process.env.PHONE_NUMBER_ID || '';
const ADMIN_NUMBER = process.env.ADMIN_NUMBER || '919580868774';
...
// Meta Incoming Messages Endpoint (POST /webhook)
